...
public abstract class FrogportRendererMixin {
    ...
    @ModifyExpressionValue(method = "renderSafe(Lcom/simibubi/create/content/logistics/packagePort/frogport/FrogportBlockEntity;FLcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;II)V", at = @At(value = "FIELD", target = "Lcom/simibubi/create/AllPartialModels;FROGPORT_HEAD_GOGGLES:Ldev/engine_room/flywheel/lib/model/baked/PartialModel;"))
    ...
    @ModifyExpressionValue(method = "renderSafe(Lcom/simibubi/create/content/logistics/packagePort/frogport/FrogportBlockEntity;FLcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;II)V", at = @At(value = "FIELD", target = "Lcom/simibubi/create/AllPartialModels;FROGPORT_HEAD:Ldev/engine_room/flywheel/lib/model/baked/PartialModel;"))
    ...
    @ModifyExpressionValue(method = "renderSafe(Lcom/simibubi/create/content/logistics/packagePort/frogport/FrogportBlockEntity;FLcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;II)V", at = @At(value = "FIELD", target = "Lcom/simibubi/create/AllPartialModels;FROGPORT_TONGUE:Ldev/engine_room/flywheel/lib/model/baked/PartialModel;"))
